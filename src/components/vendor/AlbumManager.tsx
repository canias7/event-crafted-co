...
const MAX_BYTES = 25 * 1024 * 1024; // 25 MB per photo (HD originals)
const MAX_PER_ALBUM = 200;
...
const albumsTable = () => (supabase as any).from("event_albums");
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const photosTable = () => (supabase as any).from("event_album_photos");
        ...
        <div className="space-y-4 pt-2">
          ...
          <div className="flex items-start justify-between gap-3 pt-3 border-t border-border">
            <div className="min-w-0">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Guests can download full-resolution originals from the
                public album page.
              </p>
            </div>
            <Switch
          ...
          <div className="flex items-start justify-between gap-3 pt-3 border-t border-border">
            <div className="min-w-0">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Confirm the host is OK with this album being shared with
                their guests via the link. Required before publish.
              </p>
            </div>
