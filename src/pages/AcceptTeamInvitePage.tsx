  ...
  async function accept() {
    ...
    if (!result?.ok) {
      const map: Record<string, string> = {
        ...
        expired: "This invite has expired. Ask your teammate to send a new one.",
        email_mismatch:
      ...
      <div className="container mx-auto px-6 md:px-8 py-20 max-w-md">
        <div className="text-center">
          ...
          <p className="text-sm text-muted-foreground mb-8 leading-relaxed">
            ...
            {invite.role === "admin"
              ? " You'll be able to manage inquiries, templates, the team, and the vendor profile."
              : " You'll be able to manage inquiries, templates, and availability."}
          </p>
          ...
          {isExpired ? (
            ...
            <div className="space-y-3">
              ...
              <Link
                to={`/login?next=${encodeURIComponent(`/accept-team-invite/${token}`)}`}
              >
              ...
              <Link
                to={`/signup?email=${encodeURIComponent(invite.email)}&next=${encodeURIComponent(`/accept-team-invite/${token}`)}`}
              >
