  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <main id="main-content" className="flex-1 pb-20 lg:pb-0">
        <div className="border-b border-border/40 bg-card/60 backdrop-blur px-4 md:px-8 py-5 sticky top-0 z-40 flex items-center justify-between flex-wrap gap-4">
          <div>
            <h1 className="font-editorial text-3xl">Team</h1>
