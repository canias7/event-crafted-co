...
import { BulkMessageDialog } from "@/components/customer/BulkMessageDialog";
import { ImportGuestsDialog } from "@/components/customer/ImportGuestsDialog";
    ...
    <div className="flex min-h-screen bg-background">
      ...
      <main id="main-content" className="flex-1 pb-20 lg:pb-0">
        <div className="border-b border-border bg-card px-4 md:px-8 py-4 sticky top-0 z-40 space-y-3">
          ...
          <div>
            <h1 className="font-editorial text-3xl">Guests</h1>
