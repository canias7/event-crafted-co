// Vendor signup. Creates the auth user; the existing Supabase trigger
// on `auth.users` (already in place for the web app) will populate
// `profiles` + assign the `vendor` role. Onboarding details live on
// /(vendor)/listing once the user lands.
    ...
    <SafeAreaView className="flex-1 bg-background">
      ...
      >
        <Text className="mb-1 text-3xl font-semibold text-foreground">
          Become a Vendora vendor
        </Text>
        <Text className="mb-8 text-sm text-muted-foreground">
          Create an account to start receiving inquiries.
        </Text>
